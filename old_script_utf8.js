...
//  SCRIPT.JS ΓÇö UI Logic, Navigation, Screens
//  Depends on: backend.js (must load first)
// ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ

// ΓöÇΓöÇ NAVIGATION ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ LEAVE CONFIRMATION MODAL ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ ROOMS LIST ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ HANDLE JOIN ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ PASSWORD MODAL ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ LOADING SCREEN ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function loadRoom(room) {
  ...
  document.getElementById("loadingLabel").textContent  = "ENTERING THE ARENAΓÇª";
  ...
  let progress = 0;
  const messages = [
    "SADDLING UP THE HORSESΓÇª",
    "CHECKING RACE CONDITIONSΓÇª",
    "SETTING THE TRACKΓÇª",
    "COUNTING JOCKEYSΓÇª",
    "GATES ARE OPENINGΓÇª",
  ];
  let msgIdx = 0;
...
// ΓöÇΓöÇ LOBBY ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function renderLobby(room) {
  ...
  const pwDisplay = room.password
    ? `<span id="pwText">ΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇó</span>
  ...
  details.innerHTML = `
    ...
    <div class="detail-cell">
      ...
      <div class="detail-value gold">${room.stake} ≡ƒ¬Ö</div>
    </div>
    <div class="detail-cell">
...
function togglePwReveal(pw) {
  ...
  if (el.textContent === "ΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇó") {
    el.textContent = pw;
    msg.style.display = "inline";
    setTimeout(() => { el.textContent = "ΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇó"; msg.style.display = "none"; }, 3000);
  } else {
    el.textContent = "ΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇó";
    msg.style.display = "none";
  }
}

// ΓöÇΓöÇ START RACE FROM LOBBY ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function startRaceFromLobby() {
  ...
  // Transition to game ΓÇö for now show the race screen from old game
  // (This plugs into the existing race engine in the game section)
  balance -= activeRoom.stake;
  // Jump to game (existing race page) ΓÇö kept in same SPA
  showRaceGame();
}

// ΓöÇΓöÇ RACE GAME (existing engine) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function buildRaceScreenHTML() {
  ...
  <div class="sub-top-bar">
    ...
    <div class="hlogo-fallback" style="display:none">≡ƒÅç ELITE</div>
  ...
  <div class="race-info-strip">
    ...
    <div class="race-info-cell" id="gameRoomNameCell">
      ...
      <span class="ric-val" id="gameRoomName" style="color:var(--gold)">ΓÇö</span>
    </div>
    <div class="race-info-cell">
      <span class="ric-label">ENTRY STAKE</span>
      <span class="ric-val" id="gameStake" style="color:var(--gold-light)">ΓÇö</span>
    </div>
  </div>
    ...
    <div class="game-main-layout">
      ...
      <div class="game-col-left">
        <div class="game-track-area">
          <div class="game-track-labels"><span>≡ƒÅü START</span><span>FINISH ≡ƒÅü</span></div>
          <div class="game-track">
            <div class="game-start-line"></div>
            <div class="game-finish-line"></div>
            <div class="game-finish-flag">≡ƒÅü</div>
        ...
        <div class="game-section">
          <div class="game-section-header">
            <span class="game-section-title">≡ƒÉÄ  PICK YOUR HORSE</span>
        ...
        <div class="game-payout-preview" id="gamePayoutPreview" style="display:none">
          <div class="gpp-row">
            <span class="gpp-item"><span class="gpp-label">Horse</span><span class="gpp-val" id="gpvHorse">ΓÇö</span></span>
            <span class="gpp-item"><span class="gpp-label">Odds</span><span class="gpp-val" id="gpvOdds">ΓÇö</span></span>
            <span class="gpp-item"><span class="gpp-label">Potential Win</span><span class="gpp-val gpp-win" id="gpvWin">ΓÇö</span></span>
          </div>
        </div>
      </div>
      ...
      <div class="game-col-right">
        <div class="game-howto-panel">
          ...
          <div class="howto-tip">
            <span>≡ƒÆí</span> <em>Lower odds = more likely to win, less payout. High odds = high risk, high reward!</em>
          </div>
        </div>
          ...
          <div class="game-bet-module" id="gameBetModule">
            <div class="game-bet-controls">
              <div class="game-bet-input-wrap">
                <span class="game-bet-currency">≡ƒ¬Ö</span>
        ...
        <div class="game-side-panel">
          <div class="ghs-header-row">
            <div class="ghs-label">≡ƒÅç  LIVE BETS</div>
          </div>
...
// ΓöÇΓöÇ CSS INJECTION for race screen ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
(function injectRaceCSS() {
  const s = document.createElement("style");
  s.textContent = `
  /* ΓöÇΓöÇ Race Info Strip ΓöÇΓöÇ */
  ...
  /* ΓöÇΓöÇ Scrollable Game Content ΓöÇΓöÇ */
  ...
  /* ΓöÇΓöÇ Instruction Banner ΓöÇΓöÇ */
  ...
  /* ΓöÇΓöÇ Horse Cards Grid ΓöÇΓöÇ */
  ...
  .game-horse-card.selected::after{content:'Γ£ô SELECTED';position:absolute;top:8px;right:10px;font-family:var(--font-ui);font-size:10px;font-weight:700;color:var(--gold);letter-spacing:1px}
  ...
  /* ΓöÇΓöÇ Header Countdown Pulse ΓöÇΓöÇ */
  ...
  /* ΓöÇΓöÇ Live Bet Statuses ΓöÇΓöÇ */
  ...
  /* ΓöÇΓöÇ Race Log Report Table ΓöÇΓöÇ */
  ...
  /* ΓöÇΓöÇ Bet Bar (mobile: fixed bottom) ΓöÇΓöÇ */
  ...
  /* ΓöÇΓöÇ Two-Column Layout (base: single column) ΓöÇΓöÇ */
  ...
  /* ΓöÇΓöÇ How to Play Panel ΓöÇΓöÇ */
  ...
  /* ΓöÇΓöÇ Desktop: two-column, viewport-fit, no scroll ΓöÇΓöÇ */
...
// ΓöÇΓöÇ RACE GAME ENGINE ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function initRaceGame() {
  ...
  if (activeRoom) {
    ...
    document.getElementById("gameStake").textContent    = activeRoom.stake + " ≡ƒ¬Ö";
  }
...
function buildGameBettingPanel() {
  ...
  horses.forEach((h, i) => {
    ...
    card.innerHTML = `
      ...
      <div class="ghc-jockey">≡ƒºæ ${h.jockey}</div>
...
function executeRace(betAmt) {
  ...
  document.getElementById("gameRaceStatus").textContent = "≡ƒÅç Race in progress...";
...
function gameEndRace(winner, betAmt) {
  ...
  if (won) {
    ...
    document.getElementById("gameResultTitle").textContent = "≡ƒÅå WINNER! #" + (winner+1) + " " + horses[winner].name;
    ...
    document.getElementById("gameResultTitle").textContent = "≡ƒÿö #" + (winner+1) + " " + horses[winner].name + " wins!";
    ...
    if (gamePhase === "betting") {
      return `
        <div class="game-live-bet-card ready">
          ...
          <div class="glb-info">
            <span class="glb-status ready">Bid Ready Γ£ô</span>
          </div>
        </div>
      `;
    }
...
function gameRenderHistory() {
  ...
  list.innerHTML = "";
  if (history.length === 0) {
    list.innerHTML = `<span class="ghs-empty">No races yet ΓÇö place your first bet!</span>`;
    return;
  }
...
// ΓöÇΓöÇ SVG HORSE BUILDER ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ RELOAD WARNING ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ CREATE ROOM LOGIC ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

let selectedStakeVal = 50;
let selectedIconVal  = "≡ƒÄ«";
...
function selectStake(val, e) {
  ...
  document.getElementById("selected-stake").textContent = `${val} CREDITS ≡ƒ¬Ö`;
...
function handleCreateRoom() {
  ...
  const newRoom = {
    ...
    tag: "fast",
    tagLabel: pass ? "Γÿà PRIVATE" : "ΓÜí FAST PLAY",
...
// ΓöÇΓöÇ LOBBY INVITE LOGIC ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ JOIN BY CODE LOGIC ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
